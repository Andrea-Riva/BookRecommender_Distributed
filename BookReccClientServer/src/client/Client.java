...
//esempio dalla casella di testo viene recuperato il titolo
    // viene inviato sull output verso l'handler la stringa del metodo richiesto e i parametri
    //infine se non ci sono errori viene preso in input il dato richiesto
