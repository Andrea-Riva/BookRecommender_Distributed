...
public class ServConsigliImp implements ServiziConsigli {
    ...
    public  boolean DBinserisciCongili( int userId, String referenced, String libro1, String libro2, String libro3) {
        ...
        try {
            ...
            System.err.println("Errore dutante l'inserimento: "+e.getMessage());
            e.printStackTrace();
        }
        return false;
    }
    ...
    public  int  DBGetIDLibro(String titolo) {
        ...
        try {
            ...
            System.err.println("Recupero id libro non effettuato a causa di un errore: "+e.getMessage());
            e.printStackTrace();
            return -1;
        }
    ...
    public List<Libro> DBReturnConsigli(String titolo) {
        ...
        try {
            ...
            System.err.println("Eorrere nel recupero dei consigli: "+e.getMessage());
            e.printStackTrace();
